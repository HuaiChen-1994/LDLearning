...
if __name__=='__main__':
    ...
    for npy_name in npy_name_list[:]:
        ...
        checkpoint_save_path=os.path.join('random_initialization',dataset_name+'_'+segmentation_object)
        ...
        ######test 
        test_out_path=os.path.join('./output','random_initialization',dataset_name+'_'+segmentation_object)
