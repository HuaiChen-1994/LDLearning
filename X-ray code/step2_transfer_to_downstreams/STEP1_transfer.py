...
if __name__=='__main__':
    ...
    pre_trained_models_list=[
                            ['../step1_ld_pretraining/checkpoint_pd_mixup_(8, 8)_32','ld_(8, 8)_32_16','vgg16_bn_tiny'],
    ...
    for train_rate in train_rate_list:
        for pre_trained_checkpoint_path,pre_trained_model_name,arch in pre_trained_models_list[:]:
            ...
            for npy_name,batch_size in npy_name_list[:]:
                ...
                checkpoint_save_path=os.path.join(pre_trained_model_name,dataset_name+'_'+segmentation_object,str(train_rate))
                ...
                ######test 
                test_out_path=os.path.join(test_out_save_path,pre_trained_model_name,'frozen',dataset_name+'_'+segmentation_object,str(train_rate))
                ...
                test_out_path=os.path.join(test_out_save_path,pre_trained_model_name,'fine',dataset_name+'_'+segmentation_object,str(train_rate))
                check_and_create_folder(test_out_path)
