...
if __name__=='__main__':
    ...
    child_path_list=os.listdir(args['dataset_path'])
    train_data_list=[]
    for child_path in child_path_list:
        train_data_list=train_data_list+[os.path.join(child_path,data_instance) for data_instance in os.listdir(os.path.join(args['dataset_path'],child_path))]
